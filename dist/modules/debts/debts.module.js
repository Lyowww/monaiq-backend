...
exports.DebtsModule = DebtsModule = __decorate([
    (0, common_1.Module)({
        imports: [mongoose_1.MongooseModule.forFeature([{ name: debt_schema_1.Debt.name, schema: debt_schema_1.DebtSchema }])],
        controllers: [debts_controller_1.DebtsController],
        providers: [debts_service_1.DebtsService],
        exports: [debts_service_1.DebtsService, mongoose_1.MongooseModule]
    })
], DebtsModule);
